...
export const siteConfig = {
  ...
  featureHighlight: [
    ...
    },
    {
      ...
      videoSrc: "/videos/restore-light.mp4",
      videoSrcDark: "/videos/restore-dark.mp4",
      posterSrc: "/images/restore-light-poster.jpg",
      posterSrcDark: "/images/restore-dark-poster.jpg",
      direction: "ltr" as const,
    },
  ],
  tapToPay: {
